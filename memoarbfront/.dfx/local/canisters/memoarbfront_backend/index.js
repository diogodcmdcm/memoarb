...
import { idlFactory } from './memoarbfront_backend.did.js';
export { idlFactory } from './memoarbfront_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMOARBFRONT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./memoarbfront_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the memoarbfront_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./memoarbfront_backend.did.js")._SERVICE>}
 */
export const memoarbfront_backend = createActor(canisterId);
