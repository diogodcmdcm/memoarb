...
import { idlFactory } from './memoarbfront_frontend.did.js';
export { idlFactory } from './memoarbfront_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMOARBFRONT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./memoarbfront_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the memoarbfront_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./memoarbfront_frontend.did.js")._SERVICE>}
 */
export const memoarbfront_frontend = createActor(canisterId);
